...
final class SendTransactionNotification implements ShouldQueue
{
    ...
    private function data(object $event): array
    {
        return match (true) {
            ...
            $event instanceof WalletHoldPlaced, $event instanceof WalletHoldReleased => $this->amountData(
                $event->hold->amount,
    ...
    private function recipients(object $event): array
    {
        $holders = match (true) {
            ...
            $event instanceof WalletHoldPlaced, $event instanceof WalletHoldReleased => [$event->hold->wallet->holder],
